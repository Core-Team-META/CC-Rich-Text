...
--text = "<image sword 50 50><panel -1 #FFFFFF><color red>lorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaey</panel>"
--text = text .. "<image sword 50 50><panel -1 #FFFFFF22><color red>lorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaeylorem ipsum dolor asd reaytaey</panel>"
rtm.SetImageSource(propImageDir)
local dim = rtm.DisplayText(propTargetUIPanel, text, {leftMargin = 20, topMargin = 20, rightMargin = 20, size=20})
