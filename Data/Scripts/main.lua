...
local text = [[This text is <b>bold</b>
This text has a <shadow 3 3 green>drop shadow</shadow>
<font pirata_one>This text has a font!</font>
<size 80>Big text!</size>
normal text
<size 20> little text!</size>
...
rtm.DisplayText(propTargetUIPanel, text, {leftMargin = 20, topMargin = 20, font = propBaloo2, size=50})
